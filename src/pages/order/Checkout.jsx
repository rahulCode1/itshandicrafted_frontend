...
import { emptyCartToPlaceOrder } from "../../features/cart/cartSlice";
...
const Checkout = () => {
  ...
  const handleSubmitOrder = async () => {
    ...
    const order = {
      ...
      orderPlacedBy: "69a870245630f0e4e469fc6e",
    };

    setIsLoading(true);
    try {
      const response = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}order/69a870245630f0e4e469fc6e`,
        {
          method: "POST",
          headers: {
      ...
      dispatch(emptyCartToPlaceOrder())
      navigate("/orders");
...
>
  <div className="container py-4 py-md-5">
    ...
    <div className="d-flex align-items-center gap-3 mb-4">
      ...
      <div>
        <h4 className="fw-bold mb-0" style={{ color: "#1e1b4b", letterSpacing: "-0.4px" }}>
          Checkout
        </h4>
        <span className="text-muted small">Review and place your order</span>
      </div>
    </div>
      ...
      <div className="col-12 col-md-6">
        ...
        {address && address.length > 0 && (
          <div className="d-flex align-items-center gap-2 mb-3">
            ...
            >
              <i className="bi bi-geo-alt-fill" style={{ fontSize: 13, color: "#4f46e5" }}></i>
            </span>
        ...
        {address && address.length > 0 ? (
                ...
                <div className="card-body p-3 p-md-4">
                  ...
                  <div className="d-flex align-items-center justify-content-between mb-3">
                    <div className="d-flex align-items-center gap-2">
                      ...
                      >
                        <i className="bi bi-person-fill" style={{ color: "#4f46e5", fontSize: 14 }}></i>
                      </div>
                      <h6 className="fw-bold mb-0" style={{ color: "#1e1b4b" }}>
                        {userAdd.name}
                      </h6>
                  ...
                  >
                    ...
                    <span className="small text-muted">{userAdd.phoneNumber}</span>
                  </div>

                  {/* Zip / City / State chips */}
                  <div className="row g-2 mb-3">
                    {[
                      { label: "ZIP", value: userAdd.zipCode, icon: "bi-mailbox" },
                      { label: "City", value: userAdd.city, icon: "bi-building" },
                      { label: "State", value: userAdd.state, icon: "bi-flag" },
                      ...
                      <div className="col-4" key={label}>
                        ...
                        >
                          <small
                            ...
                            style={{ fontSize: "0.62rem", textTransform: "uppercase", letterSpacing: "0.5px" }}
                          >
                            {label}
                          </small>
                          <span className="fw-bold d-block" style={{ color: "#1e1b4b", fontSize: "0.8rem" }}>
                            {value}
                          </span>
                        </div>
                      </div>
          ...
          >
            <div className="card-body">
              ...
              >
                <i className="bi bi-geo-alt" style={{ fontSize: 28, color: "#7c3aed" }}></i>
              </div>
              <h6 className="fw-bold mb-1" style={{ color: "#1e1b4b" }}>No Address Found</h6>
              <p className="text-muted small mb-3">Add a delivery address to continue.</p>
              <Link
              ...
              >
                <i className="bi bi-plus-circle-fill me-2"></i>Add New Address
              </Link>
            </div>
          </div>
        )}
        ...
        {productCart && productCart.length > 0 ? (
          ...
          >
            ...
            <div className="p-4" style={{ background: "#fff" }}>
              ...
              <div className="row g-2 mb-4">
                {[
                  { label: "Quantity", value: totalQuantity, icon: "bi-stack", color: "#4f46e5", bg: "#f5f3ff", border: "#ede9fe" },
                  { label: "Total Price", value: `₹${totalPrice}`, icon: "bi-currency-rupee", color: "#4f46e5", bg: "#f5f3ff", border: "#ede9fe" },
                  { label: "Discount", value: `₹${totalDiscount}`, icon: "bi-tag-fill", color: "#16a34a", bg: "#f0fdf4", border: "#bbf7d0" },
                  { label: "Delivery", value: "2 days", icon: "bi-truck", color: "#4f46e5", bg: "#f5f3ff", border: "#ede9fe" },
                    ...
                    >
                      <div className="d-flex align-items-center gap-2 mb-1">
                        ...
                        <small
                          ...
                          style={{ fontSize: "0.68rem", textTransform: "uppercase", letterSpacing: "0.4px" }}
                        >
                          {label}
                        </small>
                      </div>
                      <span className="fw-bold d-block" style={{ color: "#1e1b4b", fontSize: "0.95rem" }}>
                        {value}
                      </span>
                    </div>
                  </div>
              ...
              {/* Divider */}
              <div style={{ borderTop: "2px dashed #ddd6fe", marginBottom: 20 }} />
              ...
              <div className="mb-4">
                ...
                >
                  ...
                  >
                    <i className="bi bi-credit-card-fill" style={{ fontSize: 12, color: "#4f46e5" }}></i>
                  </span>
                  Payment Method
                </label>
                <select
              ...
              <p className="text-center text-muted mt-3 mb-0" style={{ fontSize: "0.72rem" }}>
                <i className="bi bi-shield-lock-fill me-1" style={{ color: "#4f46e5" }}></i>
          ...
          >
            <div className="card-body py-5 px-4">
              ...
              >
                <i className="bi bi-cart-x" style={{ fontSize: 30, color: "#7c3aed" }}></i>
              </div>
              <h6 className="fw-bold mb-1" style={{ color: "#1e1b4b" }}>Cart is Empty</h6>
